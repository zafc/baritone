...
public class MovementTraverse extends Movement {
    ...
    public MovementState updateState(MovementState state) {
        ...
        if (state.getStatus() != MovementStatus.RUNNING) {
            ...
            if ((MovementHelper.isBlockNormalCube(pb0, positionsToBreak[0]) || pb0.getBlock() instanceof AirBlock && (MovementHelper.isBlockNormalCube(pb1, positionsToBreak[1]) || pb1.getBlock() instanceof AirBlock))) {
